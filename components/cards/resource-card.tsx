...
export function ResourceCard({ resource }: { resource: Resource }) {
  return (
    <Card className="group h-full overflow-hidden transition duration-300 hover:-translate-y-1 hover:border-primary/35 hover:shadow-glow">
      {resource.coverImage ? (
      ...
      <CardContent>
        ...
        {resource.priceNote ? (
          <div className="mb-4 flex items-start gap-2 rounded-xl border border-border bg-background-soft p-3 text-xs leading-5 text-muted">
