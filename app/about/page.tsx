...
export const metadata: Metadata = buildMetadata({
  title: "About Us",
  description: "About Astra Parallax, an independent digital studio and publishing hub for content, design, AI workflows, and curated resources.",
  path: "/about"
});
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <p className="mt-6 text-lg leading-8 text-muted">
          Astra Parallax brings together mystery and technology content, blog writing, AI-assisted workflows, design work, websites, print-on-demand concepts, and curated resources.
          It is designed to make every release easy to discover and every visitor path easier to understand.
        </p>
